namespace Dapper.FastCrud.SqlStatements
{
    ...
    internal abstract class RelationshipSqlStatements<TEntity> : ISqlStatements<TEntity>
    {
        ...
        /// </summary>
        public abstract TEntity SelectById(IDbConnection connection, TEntity keyEntity, AggregatedSqlStatementOptions statementOptions);

        /// <summary>
        /// Performs a SELECT operation on a single entity, using its keys
        /// </summary>
        public abstract Task<TEntity> SelectByIdAsync(IDbConnection connection, TEntity keyEntity, AggregatedSqlStatementOptions statementOptions);

        /// <summary>
        /// Performs a COUNT on a range of items.
        /// </summary>
        public abstract int Count(IDbConnection connection, AggregatedSqlStatementOptions statementOptions);

        /// <summary>
        /// Performs a COUNT on a range of items.
        /// </summary>
        public abstract Task<int> CountAsync(IDbConnection connection, AggregatedSqlStatementOptions statementOptions);

        /// <summary>
        /// Performs a common SELECT 
        /// </summary>
        public abstract IEnumerable<TEntity> BatchSelect(IDbConnection connection, AggregatedSqlStatementOptions statementOptions);

        /// <summary>
        /// Performs a common SELECT 
        /// </summary>
        public abstract Task<IEnumerable<TEntity>> BatchSelectAsync(IDbConnection connection, AggregatedSqlStatementOptions statementoptions);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Task InsertAsync(IDbConnection connection, TEntity entity, AggregatedSqlStatementOptions statementOptions)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Task<bool> UpdateByIdAsync(IDbConnection connection, TEntity keyEntity, AggregatedSqlStatementOptions statementOptions)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Task<bool> DeleteByIdAsync(IDbConnection connection, TEntity keyEntity, AggregatedSqlStatementOptions statementoptions)
        {
