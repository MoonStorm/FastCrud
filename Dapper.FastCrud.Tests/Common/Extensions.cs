namespace Dapper.FastCrud.Tests.Common
{
    ...
    public static class Extensions
    {
        ...
        public static string GetDirectory(this Assembly assembly)
        {
            ...
            //For example, if the assembly was downloaded from the internet, its CodeBase may start with â€œhttp://â€, but its Location may start with â€œC:\â€. 
            // If the file was shadow copied, the Location would be the path to the copy of the file in the shadow-copy dir.
            //Itâ€™s also good to know that the CodeBase is not guaranteed to be set for assemblies in the GAC.Location will always be set for assemblies loaded from disk, however.
