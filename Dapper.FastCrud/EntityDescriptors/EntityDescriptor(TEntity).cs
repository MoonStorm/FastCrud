namespace Dapper.FastCrud.EntityDescriptors
{
    ...
    {
        private readonly Lazy<EntityMapping> _defaultEntityMapping;
        ...
        public EntityDescriptor()
            :base(typeof(TEntity))
        {
            _defaultEntityMapping = new Lazy<EntityMapping>(
                ()=> new AutoGeneratedEntityMapping<TEntity>().AutoGeneratedRegistration, 
                LazyThreadSafetyMode.PublicationOnly);
        }

        protected override EntityMapping DefaultEntityMappingRegistration => _defaultEntityMapping.Value;

        protected override ISqlStatements ConstructSqlStatements(EntityMapping entityMapping)
        {
