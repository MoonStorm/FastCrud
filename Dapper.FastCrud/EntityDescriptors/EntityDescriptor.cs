namespace Dapper.FastCrud.EntityDescriptors
{
    ...
    internal abstract class EntityDescriptor
    {
        ...
        private EntityRegistration? _currentEntityMappingRegistration;
        ...
        private readonly ConditionalWeakTable<EntityRegistration, ISqlStatements> _historicEntityMappingRegistrations;
        ...
        protected EntityDescriptor(Type entityType)
        {
            ...
            _historicEntityMappingRegistrations = new ConditionalWeakTable<EntityRegistration, ISqlStatements>();
        }
        ...
        /// </summary>
        public ISqlStatements GetSqlStatements(EntityRegistration? entityMapping = null)
        {
        ...
        protected abstract ISqlStatements ConstructSqlStatements(EntityRegistration entityMapping);
    }
}
