namespace Dapper.FastCrud.SqlBuilders
{
    ...
    internal abstract class GenericStatementSqlBuilder : ISqlBuilder
    {
        ...
        private readonly Lazy<string> _noAliasFullFunctionCallClause;
        private readonly Lazy<string> _autoGeneratedTableAliasName;
            ...
            SqlDialect dialect)
        {
            ...
            _noAliasFullFunctionCallClause = new Lazy<string>(() => this.GetFullFunctionCallClauseInternal(), LazyThreadSafetyMode.PublicationOnly);
            _autoGeneratedTableAliasName = new Lazy<string>(() => this.GetTableAliasNameInternal(), LazyThreadSafetyMode.PublicationOnly);
        ...
        /// <summary>
        /// Returns a table alias name generated by table name.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string GetTableAliasName()
        {
            return _autoGeneratedTableAliasName.Value;
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public string GetFullFunctionCallClause(string tableAlias = null)
        {
            return tableAlias == null ? _noAliasFullFunctionCallClause.Value : this.GetFullFunctionCallClauseInternal(tableAlias);
        }
            ...
            long? limitRowsCount = null)
        {
            ...
            for (var secondEntityJoinInstructionIndex = 0; secondEntityJoinInstructionIndex < allSqlJoinInstructions.Length; secondEntityJoinInstructionIndex++)
            {
                ...
                var secondEntityTableAlias = secondEntitySqlBuilder.GetTableAliasName();
                ...
                if (selectClauseBuilder != null)
                {
                    ...
                    selectClauseBuilder.Append(secondEntitySqlBuilder.ConstructColumnEnumerationForSelect(secondEntityTableAlias));
                }
                ...
                if (secondEntityJoinInstructionIndex == 0)
                {
                    fromClauseBuilder.Append(secondEntitySqlBuilder.GetTableName(secondEntityTableAlias));
                }
                else
                {
                    ...
                    for (var firstEntityJoinInstructionIndex = 0; firstEntityJoinInstructionIndex < secondEntityJoinInstructionIndex; firstEntityJoinInstructionIndex++)
                    {
                        ...
                        for (var firstEntityPropertyIndex = 0; firstEntityPropertyIndex < firstEntityPropertyMappings.Length; firstEntityPropertyIndex++)
                        {
                            ...
                            string firstEntityTableAlias = firstEntitySqlBuilder.GetTableAliasName();
                            joinClauseBuilder.Append(firstEntitySqlBuilder.GetColumnName(firstEntityProperty, firstEntityTableAlias, false));
                            joinClauseBuilder.Append('=');
                            ...
                            joinClauseBuilder.Append(secondEntitySqlBuilder.GetColumnName(secondEntityProperty, secondEntityTableAlias, false));
                        }
                        joinClauseBuilder.Append(')');
                    }
        ...
        protected virtual string GetTableNameInternal(string tableAlias = null)
        {
            ...
            {
                fullTableName = $"{fullTableName}({tableValuedFunctionEntityMapping.ConstructFunctionParameterClause()})";
            }

            return this.ResolveWithCultureInvariantFormatter($"{fullTableName}{sqlAlias}");
        }

        private string GetTableAliasNameInternal()
        {
            FormattableString tableAlias = $"{this.GetDelimitedIdentifier(this.EntityMapping.TableName)}";
            return this.ResolveWithCultureInvariantFormatter(tableAlias);
        }

        private string GetFullFunctionCallClauseInternal(string tableAlias = null)
        {
            var sqlAlias = tableAlias == null
               ? string.Empty
               : $" AS {this.GetDelimitedIdentifier(tableAlias)}";
            ...
            if (this.EntityMapping is ITableValuedFunctionEntityMapping tableValuedFunctionEntityMapping)
            {
                fullTableName = $"{this.EntityMapping.TableName}({tableValuedFunctionEntityMapping.ConstructFunctionParameterClause()}){sqlAlias}";
            }
            else
            {
                fullTableName = $"{this.EntityMapping.TableName}{sqlAlias}";
            }

            return this.ResolveWithCultureInvariantFormatter(fullTableName);
        }
